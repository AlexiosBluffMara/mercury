"""
Email platform adapter for the Mercury gateway.

Allows users to interact with Mercury by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Mercury Agent")
        ...
        msg_id = f"<mercury-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
