...
const STORAGE_KEY = "mercury-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `mercury_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "mercury-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-mercury-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-mercury-theme-font", "true");
