 ...
 * `window.__MERCURY_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Mercury brand in the top bar
 ...
 *  `window.__MERCURY_PLUGINS__.registerSlot(...)`.
 *
