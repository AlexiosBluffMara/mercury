"""
Skills configuration for Mercury Agent.
`mercury skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.mercury/config.yaml under:
...
from mercury_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `mercury skills`."""
    from mercury_cli.curses_ui import curses_checklist
