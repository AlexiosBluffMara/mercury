...
`hermes backup` creates a zip archive of the entire ~/.mercury/ directory
...
from mercury_constants import get_default_hermes_root, get_hermes_home, display_hermes_home
