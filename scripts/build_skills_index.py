#!/usr/bin/env python3
"""Build the Mercury Skills Index — a centralized JSON catalog of all skills.
...
`mercury skills search/install` can use it without hitting the GitHub API.
...
# Ensure MERCURY_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("MERCURY_HOME", os.path.join(os.path.expanduser("~"), ".mercury"))
...
def main():
    print("Building Mercury Skills Index...", flush=True)
