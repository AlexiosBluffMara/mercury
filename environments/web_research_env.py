...
Inspired by: GroceryMind — production Mercury agent doing live web research
             across German grocery stores (firecrawl + mercury-agent)
"""
...
# Ensure mercury-agent root is on path
...
class WebResearchEnvConfig(MercuryAgentEnvConfig):
...
class WebResearchEnv(MercuryAgentBaseEnv):
    """
