"""
MercurySweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser mercury
    run-api
    python environments/mercury_swe_env.py serve \\
...
class MercurySweEnv(MercuryAgentBaseEnv):
    ...
    name = "mercury-swe"
    env_config_cls = MercurySweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[MercurySweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = MercurySweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepMercury-3-Llama-3-3B-Preview",
            tool_call_parser="mercury",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="mercury-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepMercury-3-Llama-3-3B-Preview",
