...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("mercury")
        class MercuryToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "mercury", "mistral", "llama3_json")
...
from environments.tool_call_parsers.mercury_parser import MercuryToolCallParser  # noqa: E402, F401
