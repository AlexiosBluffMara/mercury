...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Mercury also honours MERCURY_CA_BUNDLE (its own convention)
    ...
    """
    for env_var in ("MERCURY_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE"):
...
_PROVIDER_PREFIXES: frozenset[str] = frozenset({
    ...
    "ollama",
    "stepfun", "opencode", "zen", "go", "vercel", "evo-link", "evo_link", "kilo", "dashscope", "aliyun", "qwen",
    "mimo", "xiaomi-mimo",
    "arcee-ai", "arceeai",
    "xai", "x-ai", "x.ai", "grok",
...
# Minimum context length required to run Mercury Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Mercury from probing-down to
...
def _get_context_cache_path() -> Path:
    ...
    return get_mercury_home() / "context_length_cache.yaml"
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Mercury grow conversations past the runtime limit and Ollama
...
def get_model_context_length(
    ...
    if effective_provider in ("copilot", "copilot-acp", "github-copilot"):
        try:
            from mercury_cli.models import get_copilot_model_context
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Mercury sends to providers:
