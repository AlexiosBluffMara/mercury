...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - mercury_home (str): The active MERCURY_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.mercury``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "mercury").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'mercury memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], mercury_home: str) -> None:
        ...
        Called by 'mercury memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``mercury_home`` is the active MERCURY_HOME directory path.
