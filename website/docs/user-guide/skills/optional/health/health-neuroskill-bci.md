...
| | |
|---|---|
| Source | Optional — install with `mercury skills install official/health/neuroskill-bci` |
...
Connect Mercury to a running [NeuroSkill](https://neuroskill.com/) instance to read
