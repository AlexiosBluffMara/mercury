---
title: "Blender Mcp — Control Blender directly from Mercury via socket connection to the blender-mcp addon"
sidebar_label: "Blender Mcp"
description: "Control Blender directly from Mercury via socket connection to the blender-mcp addon"
---
...
| | |
|---|---|
| Source | Optional — install with `mercury skills install official/creative/blender-mcp` |
...
Control a running Blender instance from Mercury via socket on TCP port 9876.
