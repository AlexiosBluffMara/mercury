...
| | |
|---|---|
| Source | Optional — install with `mercury skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.mercury/skills/security/oss-forensics/`
