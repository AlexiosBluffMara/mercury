...
| | |
|---|---|
| Source | Optional — install with `mercury skills install official/research/qmd` |
...
Mercury Agent via the native MCP client. This is the preferred
...
Then configure Mercury Agent to connect via HTTP:
