...
To reply non-interactively from Mercury, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Mercury)** — pipe the message via stdin:
