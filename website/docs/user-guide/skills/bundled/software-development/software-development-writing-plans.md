...
| Version | `1.1.0` |
| Author | Mercury Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Mercury:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Mercury tools to understand the project:
