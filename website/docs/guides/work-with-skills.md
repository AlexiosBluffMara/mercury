...
What happens:
1. The skill directory is copied to `~/.mercury/skills/`
...
```bash
mkdir -p ~/.mercury/skills/my-category/my-skill
```

### 2. Write SKILL.md

```markdown title="~/.mercury/skills/my-category/my-skill/SKILL.md"
---
name: my-skill
