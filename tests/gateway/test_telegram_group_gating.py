...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @mercury_bot", entities=[_mention_entity("hi @mercury_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message("/status@mercury_bot", entities=[_mention_entity("/status@mercury_bot")])
    ) is True
