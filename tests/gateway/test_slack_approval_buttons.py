...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "mercury_approve_once" in action_ids
        assert "mercury_approve_session" in action_ids
        assert "mercury_approve_always" in action_ids
        assert "mercury_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_resolves_approval(self):
        ...
        action = {
            "action_id": "mercury_approve_once",
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "mercury_deny", "value": "session-key"}
