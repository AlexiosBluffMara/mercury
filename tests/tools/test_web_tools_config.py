...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_mercury_home_override(self, tmp_path):
        """Auth lookup should read from MERCURY_HOME/auth.json, not ~/.mercury/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".mercury").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``mercury tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
