...
def _enable_managed_nous_tools(monkeypatch):
    ...
    mercury_cli.auth and mercury_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("mercury_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("mercury_cli.models.check_nous_free_tier", lambda: False)
