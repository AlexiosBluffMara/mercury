...
class TestParserRegistry:
    ...
    def test_mercury_parser_registered(self):
        parsers = list_parsers()
        assert "mercury" in parsers
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["mercury"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use mercury format since that's universal
