...
The main() function in mercury_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `mercury -c model`
...
def _build_parser():
    """Build a minimal replica of the mercury top-level parser."""
