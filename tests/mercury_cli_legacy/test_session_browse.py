"""Tests for the interactive session browser (`mercury sessions browse`).
...
from mercury_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """mercury sessions browse should be parseable."""
        from mercury_cli.main import main as _main_entry
