...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_providers_py(self):
        from mercury_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from mercury_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from mercury_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_lowercase_model_provider(self):
        ...
        from mercury_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in MERCURY_OVERLAYS
        overlay = MERCURY_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify mercury doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from mercury_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from mercury_cli.providers import MERCURY_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = MERCURY_OVERLAYS["xiaomi"]
