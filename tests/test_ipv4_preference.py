...
def _reload_constants():
    """Reload mercury_constants to get a fresh apply_ipv4_preference."""
    import mercury_constants
    importlib.reload(mercury_constants)
    return mercury_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_mercury_ipv4_patched", False) is True
