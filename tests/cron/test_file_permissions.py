...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("mercury_cli.config.get_config_path", return_value=config_path), \
             patch("mercury_cli.config.ensure_mercury_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("mercury_cli.config.get_env_path", return_value=env_path), \
             patch("mercury_cli.config.ensure_mercury_home"):
    ...
    def test_ensure_mercury_home_sets_0700(self):
        home = Path(self.tmpdir) / ".mercury"
        with patch("mercury_cli.config.get_mercury_home", return_value=home):
