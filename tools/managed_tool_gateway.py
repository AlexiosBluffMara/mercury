...
def auth_json_path():
    """Return the Mercury auth store path, respecting MERCURY_HOME overrides."""
    return get_mercury_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from mercury_cli.auth import resolve_nous_access_token
