...
CHECKPOINT_PATH = get_mercury_home() / "processes.json"
...
class ProcessRegistry:
    ...
    def spawn_via_env(
        ...
        log_path = f"{temp_dir}/mercury_bg_{session.id}.log"
        pid_path = f"{temp_dir}/mercury_bg_{session.id}.pid"
        exit_path = f"{temp_dir}/mercury_bg_{session.id}.exit"
