...
Trust levels:
  - builtin:   Ships with Mercury. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.mercury/\.env|\~/\.mercury/\.env',
     "mercury_env_access", "critical", "exfiltration",
     "directly references Mercury secrets file"),
    ...
    (r'\.mercury/config\.yaml|\.mercury/SOUL\.md',
     "mercury_config_mod", "critical", "persistence",
     "references Mercury configuration files directly"),
