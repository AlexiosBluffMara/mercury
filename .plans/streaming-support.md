# Streaming LLM Response Support for Mercury Agent
...
```
MERCURY_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("MERCURY_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `mercury_cli/config.py` | 1 | +streaming config defaults |
...
MERCURY_STREAMING_ENABLED=true
```
