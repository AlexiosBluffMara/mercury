...
- User wants **Mercury itself to drive a browser** → use Mercury' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
