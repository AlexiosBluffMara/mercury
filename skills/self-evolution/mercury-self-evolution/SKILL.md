...
metadata:
  mercury:
    tags: [self-evolution, DSPy, GEPA, skills, optimization, mercury-agent-self-evolution]
...
# Mercury Self-Evolution — Offline Skill Optimization
...
cd mercury-agent-self-evolution
...
```bash
python -m mercury_self_evolution optimize \
