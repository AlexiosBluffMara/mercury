...
```python
import sys
sys.path.insert(0, "/home/teknium/.mercury/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.mercury/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Mercury installs package this)
