#!/usr/bin/env python3
"""
SWE Runner with Mercury Trajectory Format

A runner that uses Mercury-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Mercury-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Mercury-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Mercury format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Mercury-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Mercury-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Mercury Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Mercury-Agent's built-in execution environments
    and outputs trajectories in Mercury-Agent format.
    """
    ...
    def _convert_to_mercury_format(
        self,
        ...
        """
        Convert internal message format to Mercury trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Mercury trajectory format
        trajectory = self._convert_to_mercury_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Mercury trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Mercury Trajectory Format")
    print("=" * 60)
